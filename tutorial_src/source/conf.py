...
project = u'Casbah (MongoDB + Scala) Documentation'
...
man_pages = [
    ('index', 'CasbahDocumentation', u'Casbah (MongoDB + Scala) Documentation',
...
epub_title = u'Casbah (MongoDB + Scala) Documentation'
