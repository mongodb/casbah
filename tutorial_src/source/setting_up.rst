...
Scala 2.8.0 users::
        ...
        <dependency org="com.mongodb.casbah" name="casbah_2.8.0" rev="2.0.2"/>

Scala 2.8.1 users::

        <dependency org="com.mongodb.casbah" name="casbah_2.8.1" rev="2.0.2"/>
...
The double percentages (`%%`) is not a typo---it tells SBT that the library is crossbuilt and to find the appropriate version for your project's Scala version. If you prefer to be explicit you can use this instead::
    ...
    // Scala 2.8.0
    val casbah = "com.mongodb.casbah" % "casbah_2.8.0" % "2.0.2"
    // Scala 2.8.1
...
Migrating to Casbah 2.0.2 from Casbah 1.x
========================================
