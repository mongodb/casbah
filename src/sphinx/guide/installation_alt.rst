...
.. |all_dep_urls| replace::
    http://oss.sonatype.org/content/repositories/releases/org/mongodb/casbah_2.10/2.6.2/casbah-alldep_2.10-2.7.0-RC0.jar
    http://oss.sonatype.org/content/repositories/releases/org/mongodb/casbah_2.9.2/2.6.2/casbah-alldep_2.9.3-2.7.0-RC0.jar
